...
// y añadir el nombre del cliente al final.
...
const pedidoArray = ["Aru", "Agua", "Comida"];
procesarPedido(pedidoArray);

// 2. Iteración de Arrays en Javascript
// 2.1 Crea una función llamada `sumarPares` que reciba un array de números.
// Debes iterar sobre el array, 
//sumar todos los números pares y devolver la suma.
...
const palabras = ['casa', 'control', 'mesa'];
...
const words = ['hola', 'gatos', 'perros', 'capibaras'];
console.log(buscaPalabras(words, 'gatos')) 
